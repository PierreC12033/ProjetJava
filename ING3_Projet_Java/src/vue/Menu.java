...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ajout7ComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ajout7ComboBoxActionPerformed(evt);
            }
        });
    ...
    private void ajout7ComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ajout7ComboBoxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ajout7ComboBoxActionPerformed
    ...
    private void bulletinActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bulletinActionPerformed
        ...
        if (mode1 == "Ajouter") {
            ...
            int id_Select = ((AnneeScolaire) rechercherTable.getValueAt(ligneSelectionne, 0)).getId();
            d = bdd.rechercher("Id", Integer.toString(id_Select), "Bulletin");

            if (!c.isEmpty()) {
                int id_Trimestre = ((Bulletin) d.get(0)).getIdTrimestre();
                f = bdd.rechercher("Id", Integer.toString(id_Trimestre), "Trimestre");
                String date = ((Trimestre) f.get(0)).getDebut().toString() + " :: "
                        + ((Trimestre) f.get(0)).getFin().toString();

                int id_Inscription = ((Bulletin) d.get(0)).getIdInscription();
                h = bdd.rechercher("Id", Integer.toString(id_Inscription), "Inscription");
                int id_Personne = ((Inscription) h.get(0)).getIdPersonne();
                int id_Classe = ((Inscription) h.get(0)).getIdClasse();
                m = bdd.rechercher("Id", Integer.toString(id_Personne), "Personne");
                String NomPrenom = ((Personne) m.get(0)).getNom() + " " + ((Personne) m.get(0)).getPrenom();

                ajout1Field.setText(((Bulletin) d.get(0)).getAppreciation());

                for (int i = 0; i < ajout6ComboBox.getItemCount(); i++) {
                    if (date.equals(ajout6ComboBox.getItemAt(i))) {
                        ajout6ComboBox.setSelectedIndex(i);
                    }
                }
                for (int i = 0; i < ajout7ComboBox.getItemCount(); i++) {
                    if (NomPrenom == ajout7ComboBox.getItemAt(i)) {
                        ajout7ComboBox.setSelectedIndex(i);
                    }
                }
            }
...
// TODO add your handling code here:
    ...
    private void ecoleActionPerformed(java.awt.event.ActionEvent evt) {
        eleve.setForeground(new java.awt.Color(255, 255, 255));
        enseignant.setForeground(new java.awt.Color(255, 255, 255));
        inscription.setForeground(new java.awt.Color(255, 255, 255));
        classe.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private void rSupprimerButtonActionPerformed(java.awt.event.ActionEvent evt) {
        DefaultTableModel model = (DefaultTableModel) rechercherTable.getModel();
